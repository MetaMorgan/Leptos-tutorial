...
pub fn Effects() -> impl IntoView {
    ...
    // the newtype pattern isn't neccasry here but is a godd practice
    // it avoids confustion with other possible future RWSignal<Vec<String>> contexts
    // and makes it easer to refer to it
...
fn CreateAnEffect() -> impl IntoView {
    ...
    // this will add the name to the log any time one fo the source signals changes
...
fn ManualVersion() -> impl IntoView {
    ...
    view! {
        ...
        <form on:change=on_change>
            ...
            <label>"Show Last Name" <input type="checkbox" name="use_last" checked node_ref=use_last/></label>
        </form>
